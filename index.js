...
// ตารางปิรามิดประชากร
cron.schedule('*/5 * * * *', () => {
    http.get('http://localhost:' + listenPort + '/report/pyramid')
    http.get('http://localhost:' + listenPort + '/report/pyramid60up')
    http.get('http://localhost:' + listenPort + '/report/chronic')
    http.get('http://localhost:' + listenPort + '/report/chronicdilldown')
    http.get('http://localhost:' + listenPort + '/report/convert')
    http.get('http://localhost:' + listenPort + '/report/elderlyrat')
